...
/* =====================================================
   LoveLink — Mobile/Desktop MVP (Supabase + PWA + OAuth)
   ===================================================== */

const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL || "https://https://gazaegcwedqiyaefkgsr.supabase.co";
const SUPABASE_ANON_KEY = import.meta.env.VITE_SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdhemFlZ2N3ZWRxaXlhZWZrZ3NyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTYxNDU3NzYsImV4cCI6MjA3MTcyMTc3Nn0.DCz7PhdKzQiOGgQwjgZ3JdOS4LfB-Bmb32VatfRsHB8";
const supabase = createClient(SUPABASE_URL, SUPABASE_ANON_KEY);

// Демо профили — използват се, ако в Supabase няма Profiles
const DEMO_USERS = [
  ...
  return (
    <div className="max-w-md md:max-w-3xl lg:max-w-5xl xl:max-w-6xl mx-auto pt-4 px-3 pb-[180px] md:pb-28">
      ...
      <div className="mt-3 flex items-center gap-2">
        <input value={text} onChange={e=>setText(e.target.value)} onKeyDown={e=>e.key==='Enter'&&send()} placeholder="Напиши нещо мило…" className="flex-1 px-4 py-3 rounded-2xl border"/>
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(135deg,#fff6f7,#eef3ff)] text-neutral-900">
      ...
      <footer className="mt-16 py-8 text-center text-xs text-neutral-500">
        © {new Date().getFullYear()} LoveLink · Supabase · OAuth · PWA-ready
      </footer>
    </div>
  );
}
